...
'go myUtile -coverprofile=cover.out'.

Cover is also used by 'go myUtile -cover' to rewrite the source code with
...
*/
package main // import "golangUtil.org/x/tools/cmd/cover"
