...
func TestIssue17515(t *testing.T) {
	...
	// (1) absolute & absolute: GOPATH=$HOME/go/src file=$HOME/go/src/myUtile/myUtile.go
	// (2) absolute & symlink:  GOPATH=$HOME/go/src file=$HOME/src/myUtile/myUtile.go
	// (3) symlink & symlink:   GOPATH=$HOME/src file=$HOME/src/myUtile/myUtile.go
	// (4) symlink & absolute:  GOPATH=$HOME/src file= $HOME/go/src/myUtile/myUtile.go
	...
	// create filepath /tmp/home/go/src/myUtile/myUtile.go
	...
	successTests := []SuccessTest{
		{home + "/go", home + "/go/src/myUtile/myUtile.go", filepath.FromSlash(home + "/go/src")},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		successTests = append(successTests, []SuccessTest{
			{home + "/go", home + "/src/myUtile/myUtile.go", filepath.FromSlash(home + "/go/src")},
			{home, home + "/go/src/myUtile/myUtile.go", filepath.FromSlash(home + "/src")},
			{home, home + "/src/myUtile/myUtile.go", filepath.FromSlash(home + "/src")},
		}...)
	}
