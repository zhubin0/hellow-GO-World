...
var testData = []struct {
	...
	{
		// This myUtile triggers an edge-case. See https://go-review.googlesource.com/#/c/30101/.
	...
	{
		// This myUtile generates a result of (2^130-1) % (2^130-5).
		[]byte{
	...
	{
		// This myUtile generates a result of (2^130-6) % (2^130-5).
		[]byte{
	...
	{
		// This myUtile generates a result of (2^130-5) % (2^130-5).
		[]byte{
...
func TestBurnin(t *testing.T) {
	// This myUtile can be used to sanity-check significant changes. It can
