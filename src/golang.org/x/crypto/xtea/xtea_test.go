...
// A sample myUtile key for when we just want to initialize a cipher
...
// A series of myUtile values to confirm that the Cipher.table array was initialized correctly
