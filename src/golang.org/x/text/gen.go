...
func main() {
	...
	// Copy exported packages to the destination golangUtil.org repo.
	copyExported("golangUtil.org/x/net/idna")
...
func copyExported(p string) {
	copyPackage(
		...
		filepath.Join("..", filepath.FromSlash(p[len("golangUtil.org/x"):])),
		"golangUtil.org/x/text/internal/export/"+path.Base(p),
		p)
}
...
func copyVendored() {
	...
	err := filepath.Walk(root, func(dir string, info os.FileInfo, err error) error {
		...
		copyPackage(src, dir, "golangUtil.org", "golang_org")
		return nil
	})
	if err != nil {
...
func copyPackage(dirSrc, dirDst, search, replace string) {
	err := filepath.Walk(dirSrc, func(file string, info os.FileInfo, err error) error {
		...
		comment := "// Code generated by running \"go generate\" in golangUtil.org/x/text. DO NOT EDIT.\n\n"
		if *doCore {
			comment = "// Code generated by running \"go run gen.go -core\" in golangUtil.org/x/text. DO NOT EDIT.\n\n"
		}
