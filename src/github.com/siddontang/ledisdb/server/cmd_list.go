...
func lindexCommand(c *client) error {
	...
	index, err := LedisDB.StrInt64(args[1], nil)
	if err != nil {
		return ErrValue
	}
...
func lrangeCommand(c *client) error {
	...
	start, err = LedisDB.StrInt64(args[1], nil)
	if err != nil {
		return ErrValue
	}

	stop, err = LedisDB.StrInt64(args[2], nil)
	if err != nil {
		return ErrValue
	}
...
func lTrimFrontCommand(c *client) error {
	...
	trimSize, err = LedisDB.StrInt32(args[1], nil)
