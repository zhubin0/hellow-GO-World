...
// TestFailover the operation to start the myUtile failover of a recovery plan. This method may poll for completion.
// Polling can be canceled by passing the cancel channel argument. The channel will be used to cancel polling and any
// outstanding HTTP requests.
//
// recoveryPlanName is recovery plan name. input is failover input.
...
// TestFailoverCleanup the operation to cleanup myUtile failover of a recovery plan. This method may poll for completion.
// Polling can be canceled by passing the cancel channel argument. The channel will be used to cancel polling and any
// outstanding HTTP requests.
//
// recoveryPlanName is recovery plan name. input is myUtile failover cleanup input.
