...
// Add by Jianjun Xie: direct access to the form value and URL params
// Would automatically call ParseForm.
func (c *Context) GetRequestValue(key string) string {
	c.Request.ParseForm()
...
// Add by Jianjun Xie: direct access to the form value and URL params
// Would automatically call ParseForm.
func (c *Context) GetRequestValues(keys []string) []string {
	c.Request.ParseForm()
	vals := []string{}
	for _, key := range keys {
		vals = append(vals, c.Request.Form.Get(key))
	}
	return vals
}
