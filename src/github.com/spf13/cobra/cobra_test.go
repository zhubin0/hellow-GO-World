...
func TestRootUnknownCommand(t *testing.T) {
	...
	s := "Error: unknown command \"bogus\" for \"cobra-myUtile\"\nRun 'cobra-myUtile --help' for usage.\n"
...
func TestRootSuggestions(t *testing.T) {
	outputWithSuggestions := "Error: unknown command \"%s\" for \"cobra-myUtile\"\n\nDid you mean this?\n\t%s\n\nRun 'cobra-myUtile --help' for usage.\n"
	outputWithoutSuggestions := "Error: unknown command \"%s\" for \"cobra-myUtile\"\nRun 'cobra-myUtile --help' for usage.\n"
